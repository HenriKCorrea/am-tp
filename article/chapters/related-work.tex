...
Dada a \textbf{escassez de trabalhos com abordagem puramente cross-sectional} focada em
...
\begin{enumerate}
    ...
    \item Selecionamos trabalhos que demonstrem análise de feature importance 
          ou interpretabilidade, independentemente da metodologia temporal/cross-sectional
...
A busca resultou em \textbf{3-4 trabalhos} que,
    embora não sejam perfeitamente alinhados ao nosso posicionamento cross-sectional,
...
Dataset representa snapshot de dezembro/2017 com Sales Rank coletado em janeiro/2018 (lag temporal de 1 mês),
    enquanto utilizamos dados cross-sectional de setembro/2023 sem séries temporais.
...
Li utiliza abordagem temporal (séries de 1.941 dias) focada em previsão de vendas futuras,
    enquanto nosso trabalho adota análise cross-sectional de um snapshot temporal com foco em 
...
A análise dos trabalhos relacionados revela uma lacuna importante na literatura:
    ...
    \textbf{(3)} apliquem abordagem cross-sectional em dados de marketplace digital real com features específicas de plataforma.
...
\begin{tabular}{@{}lcccc@{}}
    ...
    \addlinespace
    Abordagem & Cross-sectional & Temporal & Não especif. & Cross-sectional \\
    \addlinespace
...
\begin{enumerate}
    ...
    \item \textbf{Abordagem cross-sectional para análise de correlações:}
    Enquanto Li~(2022) foca em previsão temporal (forecast de vendas futuras usando séries históricas),
        nosso trabalho adota análise cross-sectional para identificar
    ...
    Sharma et al.~(2019) limitam-se a livros no marketplace Amazon India,
        ...
        no marketplace Amazon global (setembro/2023).
...
Este trabalho posiciona-se como uma \textbf{análise interpretativa cross-sectional}
