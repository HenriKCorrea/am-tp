...
% alta cardinalidade ou natureza não preditiva para análise cross-sectional."
...
% Extração de features temporais (delivery_date, data_collected_at)
...
% Remoção de features irrelevantes (product_image_url, product_page_url)
